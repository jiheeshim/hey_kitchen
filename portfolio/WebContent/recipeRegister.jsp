		...
		<main>
			...
			<form id="registerForm" method="post" enctype="multipart/form-data">
				<table>
					<tr>
						<td><span>음식명</span></td>
						<td><input type="text" name="recipeName" maxlength="50" placeholder="음식명을 입력해주세요."></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td id="ingrTd">
							<div>
								<input type="text" name="ingrName" placeholder="재료명 (예시 : 다진 마늘)">
								<input type="text" name="ingrAmount" placeholder="재료양 (예시 : 100g)">
								<button type="button" id="ingrAddBtn">추가</button>
							</div>
						</td>
					</tr>
					<tr>
						<td><span>요리 방법</span></td>
						<td id="imgTd">
							<div>
								<button type="button" id="imgAddBtn">+단계 추가하기</button>
								<input type="file" name="imgName"><br>
								<textarea name="imgDesc" placeholder="이미지와 관련된 요리 단계를 설명해주세요. (총 5개까지 추가 가능합니다.)"></textarea>
							</div>
						</td>
					</tr>
				</table>
