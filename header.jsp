			...
			<li class="level1"> 
				...
				<ul class="level2">
					<div class="level2_wrapper">
						...
						<li><a href="#">밀키트가 만들어지는<br>과정을 알고 싶다면?</a></li>
					</div>
				</ul>
			</li>
			<li class="level1">
		...
		<ul class="right_ul">
			...
			<li>
				<form id="searchbox">
					...
					<button type="button" id="searchbtn"><img src="image/searchicon.png" /></button>
				</form>
			</li>
		</ul>
	</nav>
...
%>
<script>
	right1.innerHTML = "<a href='#'><b>${id}님 :)</b></a>";
	right2.innerHTML = "<a href='javascript:askLogout()'>로그아웃</a>";
</script>
<%
}
%>
